...
/*!*******************************************!*\
  !*** ./src/manageState/actionCreators.js ***!
  \*******************************************/
/*! exports provided: fetchBeginAction, fetchSuccessAction, fetchFailAction, addToCartAction, setCurrentBeerAction, removeFromCartAction, incrOrderAction, decrOrderAction, validationOKaction, NoValidationAction, rmvWholeTypeFromCartAction */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!************************************!*\
  !*** ./src/manageState/actions.js ***!
  \************************************/
/*! exports provided: RMV_FROM_CART, RMV_TYPE_FROM_CART, RMV_FROM_FAVOUR, ADD_TO_CART, ADD_TO_FAVOUR, CLEAR_CART, CLEAR_FAVOUR, CURRENT_BEER, FETCH_BEGIN, FETCH_SUCCESS, FETCH_FAIL, INCR_ORDER, DECR_ORDER, VALID, NOT_VALID */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/monads/Either/verificationEitherWithMonadLaws.js":
/*!**************************************************************!*\
  !*** ./src/monads/Either/verificationEitherWithMonadLaws.js ***!
  \**************************************************************/
/*! no exports provided */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _Either__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Either */ \"./src/monads/Either/Either.js\");\n\n\n/* Verification monad Either by using Monad Laws, according to mathematical Theory of Category.  */\n\n\n/*\n ASSOCIATIVE LAW\n\nMonad are monoids, therefore it doesn't matter in what order the actions performed or\nthey are composed, because always give the same result.\n*/\n\n\n\nconsole.log( (Object(_Either__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(() => 2) + Object(_Either__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(() => 3)) + 1 === 1 + Object(_Either__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(() => 5) );   // true\nconsole.log(  Object(_Either__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(() => 2) + (Object(_Either__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(() => 3) + 1) === 1 + Object(_Either__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(() => 5) );   // true\nconsole.log( (Object(_Either__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(() => 2) + Object(_Either__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(() => 3)) + 1 );  // 6\nconsole.log( (Object(_Either__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(() => 2) + 1) + Object(_Either__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(() => 3)  ); // 6 \n\nconst add2 = (n) => Object(_Either__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(() => n + 2);\nconst multiply2 = (n) => Object(_Either__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(() => n * 2);\n\nconsole.log( Object(_Either__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(() => 10).chain(add2).chain(multiply2).valueOf() );   // 24\nconsole.log( Object(_Either__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(() => 10).chain(x => add2(x).chain(multiply2)).valueOf() );   // 24\n\n\n/*\n THE IDENTITY LAW\n\nFor every type (i.e. string, boolean, number) exist a function that maps this type to\nitself (in the same category).\n*/\n\n/*\nLeft identity\n\nMonad with a value that chain function, return the same result as this function that \ntakes the same type of value and returns the same type of monad.\n*/\n\nconsole.log(Object(_Either__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(() => 100).chain(multiply2).valueOf() === multiply2(100).valueOf());  // true\n\n\n\n\n\n/*\n Right identity\n\nIf monad with value chain with the same type of monad, that after flatten this value\nwill be unchanged.\n*/\n\nconsole.log(Object(_Either__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(() => 100).chain((x) => Object(_Either__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(() => x)).valueOf() === Object(_Either__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(() => 100).valueOf());    // true\n\n\n\n//# sourceURL=webpack:///./src/monads/Either/verificationEitherWithMonadLaws.js?");
